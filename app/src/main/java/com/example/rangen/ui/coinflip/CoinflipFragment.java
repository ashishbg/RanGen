package com.example.rangen.ui.coinflip;
...
public class CoinflipFragment extends Fragment {
    ...
    private CoinflipViewModel mViewModel;

    public static CoinflipFragment newInstance() {
        return new CoinflipFragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(CoinflipViewModel.class);
